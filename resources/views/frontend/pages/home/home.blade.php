...
@section('content')
    <section class="bg-secondary">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="h1">BEST OFFICE CLEANING & JANITORIAL SERVICES IN MARKHAM AND SURROUNDING AREAS</h1>
                    <p>Stop wasting money for poor janitorial cleaning services. BEST OFFICE CLEANING & JANITORIAL SERVICES IN MARKHAM AND SURROUNDING AREAS</h1>
                    <p>Stop wasting money for poor janitorial cleaning services</p>
                    <button class="btn btn-primary">Get a Free Quote</button>
                </div>
                <div class="col-lg-4">
                    <img src="imgs/janitor-dust-mopping.gif" alt="The image displays janitor dust mopping and a mop bucket to his right.">
                </div>
            </div>
         </div>
    ...
    <section class="">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h2 class="h2">Welcome to ISA Commercial Cleaning Services</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 bg-primary">
                    <h2 class="h2">6 REASONS WE’RE THE BEST CLEANING SERVICE IN MARKHAM</h2>
                    <ol>
